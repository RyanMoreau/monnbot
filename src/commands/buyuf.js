...
class LongUF extends Command {
  ...
  async run() {
    ...
    // User Input
    console.log(`You chose to ${colors.FgGreen}BUY${colors.Reset} the spread of ${colors.FgGreen}USD/FUT-${future}${colors.Reset}. Lets create the order:`);
...
// Descriptor
LongUF.description = `Buy Spread of USD/FUT`;

// Export Command
module.exports = LongUF;