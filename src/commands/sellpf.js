...
class ShortPF extends Command {
  ...
  async run() {
    const { flags } = this.parse(ShortPF);
    ...
    // User Input
    console.log(`You chose to ${colors.FgRed}SELL${colors.Reset} the spread of ${colors.FgRed}PERP/FUT-${future}${colors.Reset}. Lets create the order:`);
...
// Descriptor
ShortPF.description = `Sell Spread of PERP/FUT`;

// Export Command
module.exports = ShortPF;